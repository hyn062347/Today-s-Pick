...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 5, 4, 61);
    			add_location(p, file$2, 6, 4, 81);
    			add_location(main, file$2, 4, 0, 50);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file, 22, 27, 675);
    			attr_dev(a1, "href", a1_href_value = "" + (link2 + /*food*/ ctx[2]));
    			add_location(a1, file, 22, 65, 713);
    			add_location(li, file, 22, 12, 660);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(22:8) {#each foods as food}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "오늘 무엇을 먹을까요?";
    			t1 = space();
    			button = element("button");
    			button.textContent = "음식 리스트 가져오기";
    			t3 = space();
    			ul = element("ul");
    			...
    			t4 = space();
    			p = element("p");
    			p.textContent = "기능이 쏙쏙 들어가있잖아aaas";
    			t6 = space();
    			a = element("a");
    			a.textContent = "aaaaas";
    			t8 = space();
    			nav = element("nav");
    			t9 = space();
    			create_component(router.$$.fragment);
    			attr_dev(h1, "class", "svelte-1ylxl6w");
    			add_location(h1, file, 18, 4, 532);
    			attr_dev(button, "class", "svelte-1ylxl6w");
    			add_location(button, file, 19, 4, 558);
    			add_location(ul, file, 20, 4, 613);
    			add_location(p, file, 25, 4, 782);
    			attr_dev(a, "href", "/about");
    			add_location(a, file, 26, 4, 811);
    			add_location(nav, file, 27, 4, 843);
    			add_location(main, file, 17, 0, 521);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function fetchFoods() {
    		const response = await fetch('http://localhost:8081/api/foods', { method: "get" });
    		$$invalidate(0, foods = await response.json());
    		console.log(foods);
    	}
