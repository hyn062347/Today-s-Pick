...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "여기가 홈페이지입니다!kdjfhajshdjashf";
    			add_location(h1, file$3, 5, 4, 61);
    			add_location(p, file$3, 6, 4, 81);
    			add_location(main, file$3, 4, 0, 50);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "이 페이지는 프로젝트에 대한 정보를 제공합니다.";
    			add_location(h1, file$2, 5, 4, 63);
    			add_location(p, file$2, 6, 4, 83);
    			add_location(main, file$2, 4, 0, 52);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/pages/Carana.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/pages/Carana.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "Page Carana";
    			add_location(h1, file$1, 5, 4, 63);
    			add_location(p, file$1, 6, 4, 83);
    			add_location(main, file$1, 4, 0, 52);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Carana', slots, []);
    	let { name = "Carana" } = $$props;
    	const writable_props = ['name'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Carana> was created with unknown prop '${key}'`);
    	});
    ...
    class Carana extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get name() {
    		throw new Error("<Carana>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<Carana>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_default_slot(ctx) {
    	...
    	route2 = new Route({
    			props: { path: "/carana", component: Carana },
    			$$inline: true
    		});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			a1 = element("a");
    			a1.textContent = "Canara";
    			t3 = space();
    			create_component(router.$$.fragment);
    			attr_dev(a0, "href", "/about");
    			add_location(a0, file, 27, 4, 897);
    			attr_dev(a1, "href", "/carana");
    			add_location(a1, file, 28, 4, 928);
    			add_location(main, file, 18, 0, 598);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Link, Home, About, Carana });
    	return [];
    }
